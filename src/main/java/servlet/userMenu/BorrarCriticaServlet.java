...
/**
 * Clase que permite borrar la crítica de un espectáculo del sistema
 * 
...
public class BorrarCriticaServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			gestor.borrarCritica(nickAutor, espectaculo);
		...
		if (!isError)
			message = "Crítica eliminada correctamente";

		response.sendRedirect("/showit/mvc/view/userMenu/eliminarCritica/eliminarCriticaView.jsp?message="
