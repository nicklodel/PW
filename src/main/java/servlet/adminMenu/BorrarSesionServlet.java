...
/**
 * Clase que permite borrar sesiones de un espectáculo en concreto del sistema
 * 
...
public class BorrarSesionServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			gestor.cancelarSesionEspectaculo(id);
		...
		if (!isError)
			message = "Sesión borrada correctamente";
		...
		response.sendRedirect("/showit/mvc/view/adminMenu/mostrarDatosEspectaculo/imprimirDatosEspectaculoView.jsp"
				+ "?titulo=" + tituloEspectaculo);

		out.write(tituloEspectaculo);
