...
<body>
	...
	<form method="get" action="/showit/servlet/FiltrarEspectaculoServlet">
		<label>Filtrar espectáculos</label> <input class="en"
			type="text" name="categoria" placeholder="Categoría a filtrar">
		<input class="submit" type="submit" value="Filtrar categoría">
	</form>
	...
	<form method="get"
		action="/showit/servlet/MostrarDatosEspectaculoServlet">
		<label>Consulta espectáculo</label> <select class="en" name="espectaculo"
			required>
			...
			%>
		</select> <input class="submit" type="submit" value="Consultar espectáculo">
	</form>
	<%
