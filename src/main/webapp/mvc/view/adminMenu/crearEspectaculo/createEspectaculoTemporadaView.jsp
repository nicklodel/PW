...
<head>
<meta charset="UTF-8">
<title>Crear Espectáculo de Temporada</title>
</head>
<body>
	<%
	...
	<br>
	<form method="post"
		action="/showit/servlet/CreateEspectaculoTemporadaServlet">
		<!-- Pido datos al usuario. LAS PROPIEDADES SIEMPRE VAN EN EL LADO IZQUIERDO -->
		<fieldset>
		<h2>Creación de espectáculo de temporada</h2>
		<br>
		<br>
		<br>
			...
			<br> <br> <input type="text" class="un"
			...
			<br> <br> <label>Fecha</label> <input type="date" class="en"
				name="fecha" id="fecha" required> <br> <br> 
				<label>Hora</label> <input type="time" class="en"
				name="tiempo" id="hora" required>
				<br> <br>
				<input type="number" class="en" name="nEspec" placeholder="Semanas de la temporada" required>
			<br> <br> <input class="submit" type="submit" name="create"
