...
<body>
	...
	if (messageNextPage == null)
		messageNextPage = "";
	String nextPage = "../../controller/modificarDatos/modificarDatosUserController.jsp";
	%>
	...
	<form method="post"
		action="/showit/mvc/controller/modificarDatos/modificarDatosUserController.jsp">
